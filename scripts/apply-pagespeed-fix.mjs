...
css = css
  .replace('--serif: "Shippori Mincho", "Yu Mincho", serif;', '--serif: "Zen Kaku Gothic New", "Hiragino Kaku Gothic ProN", "Yu Gothic", Meiryo, sans-serif;')
  .replace('--sans: "Zen Kaku Gothic New", "Hiragino Kaku Gothic ProN", sans-serif;', '--sans: "Zen Kaku Gothic New", "Hiragino Kaku Gothic ProN", "Yu Gothic", Meiryo, sans-serif;')
