...
css = css
  .replace('--serif: "Shippori Mincho", "Yu Mincho", serif;', '--serif: "Yu Mincho", "Hiragino Mincho ProN", serif;')
  .replace('--sans: "Zen Kaku Gothic New", "Hiragino Kaku Gothic ProN", sans-serif;', '--sans: -apple-system, BlinkMacSystemFont, "Segoe UI", "Hiragino Kaku Gothic ProN", "Yu Gothic", Meiryo, sans-serif;')
